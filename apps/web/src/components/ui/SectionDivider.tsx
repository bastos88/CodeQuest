...
export function SectionDivider({
  ...
  const variants = {
    ...
    glow:
      'h-px bg-gradient-to-r from-transparent via-indigo-400/30 to-transparent shadow-[0_0_24px_rgba(108,99,255,0.18)]',
    fade:
      'h-24 bg-gradient-to-b from-transparent via-white/[0.03] to-transparent',
    strong:
