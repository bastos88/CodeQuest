...
export function SectionDivider({ variant = 'default', className = '', }) {
    const variants = {
        ...
        strong: 'h-px bg-gradient-to-r from-transparent via-purple-400/30 to-transparent shadow-[0_0_32px_rgba(139,92,246,0.2)]',
    };
