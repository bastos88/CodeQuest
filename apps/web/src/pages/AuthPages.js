...
import SocialButtons, { GithubIcon, GoogleIcon } from '../components/ui/SocialButtons';
...
function ContactForm() {
    ...
    if (state.succeeded) {
        return (_jsx("div", { className: "rounded-2xl border border-success/25 bg-success/10 px-4 py-5 text-sm text-success", children: "Mensagem enviada. Obrigado pelo contato." }));
    }
    return (_jsxs("form", { className: "space-y-4", onSubmit: handleSubmit, children: [_jsx(Field, { id: "contact-name", label: "Nome", children: _jsx(Input, { id: "contact-name", name: "name", autoComplete: "name", placeholder: "Leonardo Bastos", required: true }) }), _jsx(Field, { id: "contact-email", label: "Email", children: _jsx(Input, { id: "contact-email", name: "email", type: "email", autoComplete: "email", placeholder: "voce@exemplo.com", required: true }) }), _jsx(Field, { id: "contact-subject", label: "Assunto", children: _jsx(Input, { id: "contact-subject", name: "subject", placeholder: "Parceria, sugestao ou melhoria", required: true }) }), _jsx(Field, { id: "contact-message", label: "Mensagem", children: _jsx("textarea", { id: "contact-message", name: "message", required: true, minLength: 10, className: "min-h-[120px] w-full rounded-xl border border-border bg-background px-3 py-3 text-sm text-textPrimary outline-none transition placeholder:text-textMuted focus:border-primary", placeholder: "Escreva sua mensagem..." }) }), _jsx(ValidationError, { prefix: "Email", field: "email", errors: state.errors, className: "text-sm text-danger" }), _jsx(ValidationError, { prefix: "Mensagem", field: "message", errors: state.errors, className: "text-sm text-danger" }), _jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4 pt-2", children: [_jsxs("p", { className: "text-[11px] text-textMuted", children: ["Ao enviar, voce concorda com nossos", ' ', _jsx(Link, { to: "/termos", className: "text-textPrimary hover:text-primary", children: "Termos" }), ' ', "e", ' ', _jsx(Link, { to: "/privacidade", className: "text-textPrimary hover:text-primary", children: "Privacidade" }), "."] }), _jsx("button", { type: "submit", disabled: state.submitting, className: "inline-flex h-10 items-center rounded-full bg-primary px-5 text-sm font-semibold text-white shadow-[0_0_30px_rgba(91,107,255,0.42)] transition hover:bg-primaryHover disabled:cursor-not-allowed disabled:opacity-60", children: state.submitting ? 'Enviando...' : 'Enviar' })] })] }));
}
...
function FooterColumn({ title, links }) {
    return (_jsxs("div", { children: [_jsx("div", { className: "text-sm font-semibold text-white", children: title }), _jsx("div", { className: "mt-4 space-y-3 text-sm text-textSecondary", children: links.map((link) => (_jsx("div", { children: link.to ? (_jsx(Link, { to: link.to, className: "transition hover:text-textPrimary", children: link.label })) : (_jsx("a", { href: link.href, target: "_blank", rel: "noopener noreferrer", className: "transition hover:text-textPrimary", children: link.label })) }, link.label))) })] }));
}
